...
namespace FractalDataWorks.Generation;

/// <summary>
/// Provides utilities for calculating input hashes for incremental generation.
/// </summary>
public static class InputHashCalculator
{
    ...
    public static bool HasChanged(string? oldHash, string newHash) => 
        string.IsNullOrEmpty(oldHash) || !string.Equals(oldHash, newHash, StringComparison.Ordinal);
}